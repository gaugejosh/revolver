				...
				<div class="head-quote-text yellowbg">
					...
					<div id="page-quote-blue">
						<div class="head-quote-text">
							...
							?>
							&quot;<?php the_field('down_quote_box'); ?>&quot;
						</div>
						<div class="head-quote-attrib closing-info">
							<?php strtoupper(get_field('down_quote_attrib')); ?><br/>
							<?php get_field('down_quote_title'); ?>
						</div>
					</div>
					...
					<div class="section-title">
						<?php strtoupper(get_field('down_section_1')); ?>
					</div>
					...
					if (get_field('down_section_2') != "")
					{
						...
						?>
						<div class="section-title">
							<?php strtoupper(get_field('down_section_2')); ?>
						</div>
					<?php
					}
					...
					<div class="download-area">
						...
						<div class="download-link-area">
							...
							<a href="#" onclick="emailChecked()"><i class="fa fa-envelope-o"></i>&nbsp&nbsp;Forward to
								Friends</a><br/>
							<?php
							if ($totalfiles == 1)
							{
									...
									<div class="gallery-container">
										<div class="gallery">
														...
														<div class="slides">
															<div class="slides_content">
																<div class="social-block-slider">
																	...
																	<a href="//www.facebook.com/bpca.ny" target="_blank" class="social-icon-link"><i class="fa fa-facebook fa-3x"></i></a>

																	<br/><br/><br/>

																	<p class="html-slider-text" id="social-slide">Stay
																		in the loop with social media</p>
																</div>
															</div>
														</div>
													</li>
														...
														<div class="slides">
															<div class="slides_content">
																<div class="social-block-slider">
																	...
																	<script>
																		function sf_widget_constantcontact_2_submit(n) {
																			for (var a = n.querySelectorAll("input"), i = 0, eml = false, val = ["action=constantcontactadd"]; i < a.length; i++)if (a[i].name) {
																				if (a[i].name == "req") {
																					...
																					if (!(a[i].name != "eml" || !a[i].value))eml = true;
																					val.push(a[i].name + "=" + encodeURIComponent(a[i].value));
																				}
																			}
																			if (!eml) {
																			...
																			xml.open("POST", "http://bpca.revolverbranding.com/wp-admin/admin-ajax.php", true);
																			xml.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
																			xml.onreadystatechange = function () {
																				if (this.readyState == 4) {
																					if (this.status == 200) {
																						if (this.responseText)alert(this.responseText); else n.innerHTML = "<input type=\"text\" name=\"eml\" class=\"input\" placeholder=\"ENTER EMAIL ADDRESS\"><input type=\"submit\" value=\"Submit\"><div class=\"yay\">Thank You For Subscribing!</div>";
																	...
																	<p class="html-slider-text" id="news-slide">Stay
																		informed by signing up for our newsletter</p>
																</div>
															</div>
														</div>
													</li>
														...
														<div class="slides">
															<div class="slides_content">
																<div class="bpcp-block-slider">
																	...
																	<p class="html-slider-text" id="parks-slide">Check
																		out what's happening in the Parks</p>
																</div>
															</div>
														</div>
													</li>
											...
											<div class="slider-nav">
												...
												<button class="nextbtn" data-dir="next" style="float:right;">
													&nbsp;</button>
											</div>
										...
										<div class="slider-pagi">
											<div class="pagi-container">
												<ul></ul>
												<!-- Here Paginations will be dynamically created, depending on Number of elements in the list. -->
									...
									<div class="teaser-box-navy">
										<div class="mr1c1-text-block">
											<div id="teaser-alerts" class="mr1c1-head-text">
												STAY INFORMED WITH CUSTOM<br> E-ALERTS
											</div>
							...
							<div class="teaser-area">
								...
								if (( ! is_mobile() && ! is_tablet()) || $randomnum == 2)
								{
									...
									<div class="main-row-1-col-3">
										...
										<div class="box-read-more">
											<a id="rm-white" href="../../places-2/public-spaces#descr-area-box-1390">READ
												MORE</a>
										</div>
									</div>
								<?php
								...
								if (( ! is_mobile() && ! is_tablet()) || $randomnum == 1)
								{
									...
									<div class="twitter-foot">
										<div class="twitter-head">
											TWITTER
											<a href="http://twitter.com/bpca_ny"><i class="fa fa-twitter"></i></a>
										</div>
