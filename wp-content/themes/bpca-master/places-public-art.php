            ...
            <?php
                ...
                while ( $loop->have_posts() ) : $loop->the_post();
                    ...
                    array_push($descrinfo, array(
                                                    ...
                                                    'link-back' => get_template_directory_uri() . "/places-2/public-art-libraries#descr-area-box" . get_the_ID()
                                                )
                     );
...
function build_descr_box ($descrdetail, $rownum) {
    ...
    foreach ($descrdetail as $descrtext) {
        ...
        /*
        echo '      <div class="descr-text-1-box">';
        echo '          <div class="descr-text">';
        echo $descrtext['descr1'];
        echo '          </div>';
        echo '      </div>';
        echo '      <div class="descr-text-2-box">';
        echo '          <div class="descr-text">';
        echo $descrtext['descr2'];
        echo '          </div>';
        echo '      </div>';
         * 
         
        echo '      <div class="link-area-subtext">';
        echo $descrtext['descr-box'];
        echo '      </div>';
        echo '      <div class="link-dir-area">';
        if ($descrtext['parks_url'] != "") {
            echo '      <div class="social-icon"><i class="fa fa-comment-o"></i></div>';
            echo '      <div class="share-text"><a href="' . $descrtext['parks_url'] . '" target="_blank">Read more at BPC Parks</a></div><br />';
        }
        echo '      <div class="social-icon"><i class="fa fa-map-marker"></i></div><div class="share-text">Get Personalized Directions</div><br />';
