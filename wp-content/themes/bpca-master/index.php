		...
		<div class="main-image" style="margin-bottom: -8px">
			...
			<div class="main-image-link">
				<div class="main-image-link-text">
					<a href="/about-2/who-we-are"> READ MORE ABOUT WHO WE ARE</a>
				</div>
			</div>
		</div>
									...
									<div class="slides_content">
										<div class="social-block-slider">
											<form id="sf_widget_constantcontact_2_form" class="constantcontactwidget_form" onsubmit="return sf_widget_constantcontact_2_submit(this);">
												...
												<input class="input" type="text" placeholder="ENTER EMAIL ADDRESS" name="eml"><br>
											...
											<p class="html-slider-text" id="news-slide">Stay informed by signing up for
												our newsletter</p>
										</div>
									</div>
								</div>
								...
								<div class="slides">
									<div class="slides_content">
										<div class="bpcp-block-slider">
											...
											<p class="html-slider-text" id="parks-slide">Check out what's happening in
												the Parks</p>
										</div>
									</div>
								</div>
		...
		<div class="main-row-2-col-1">
			...
			<div class="map-image-link">
				<div class="map-image-link-text">
					<a href="https://maps.google.com?daddr=200+Liberty+Street+New+York+NY+10281" target="_blank"> GET
						DIRECTIONS TO BATTERY PARK CITY</a>
				</div>
			</div>
		</div>
		<div class="main-row-2-col-2">
			...
			<div class="building-image-link">
				<div class="building-image-link-text">
					<a href="/residential-life/buildings?leed=yes"> EXPLORE OUR LEED CERTIFIED BUILDINGS</a>
				</div>
			</div>
		</div>
